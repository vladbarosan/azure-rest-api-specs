...
These settings apply only when `--tag=package-100` is specified on the command line.

```yaml $(tag) == 'package-100'
input-file:
  - Microsoft.Web/stable/100/logicAppsManagementClient.json
```
### Tag: package-2018-11
