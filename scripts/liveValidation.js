...
`;
        ...
        zlib.deflate(query, (err, buffer) => {
            if (!err) {
                ...
                let analyticsLink = `https://analytics.applicationinsights.io/subscriptions/6b085460-5f21-477e-ba44-1035046e9101/resourcegroups/openapi-platform/components/openapiAI?q=${queryParams}&apptype=Node.JS&timespan=P1D`;
